...
public class ResearchRecruitment {
    ...
    public void researchRecruitment(){
        ...
        //累加可兑换积分与总积分
        pointObject.setExchangeScore(pointObject.getExchangeScore() + RESEARCH_RECRUITMENT_SCORE);
        pointObject.setScoreTotal(pointObject.getScoreTotal() + RESEARCH_RECRUITMENT_SCORE);
        //写回积分文件
